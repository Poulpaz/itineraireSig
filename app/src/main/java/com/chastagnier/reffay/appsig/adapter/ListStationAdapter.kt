...
class ListStationAdapter() : ListAdapter<Station, ListStationAdapter.StationViewHolder>(DiffStationCallback()) {
    ...
    inner class StationViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(station: Station) {
            ...
            itemView.item_station_name.text = station.name
    ...
    class DiffStationCallback : DiffUtil.ItemCallback<Station>() {
        ...
        override fun areItemsTheSame(p0: Station, p1: Station): Boolean = p0.id == p1.id

        override fun areContentsTheSame(p0: Station, p1: Station): Boolean = p0.id == p1.id
